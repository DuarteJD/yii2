...
<div class="page">
    <div class="page-content">
        <div class="page-brand-info">
            ...
            <p class="font-size-20"></p>
            <p class="font-size-20"></p>
            <p class="font-size-20">A ferramenta voltada para o varejo moderno.</p>            
            <p class="font-size-20">Administre os pedidos recebidos pela página de vendas disponibilizada ao consumidor final.</p>
        ...
        <div class="page-login-main animation-slide-right animation-duration-1">
            <div class="brand hidden-md-up">
                ...
                <h3 class="brand-text font-size-40">Login dos administradores</h3>
            </div>
